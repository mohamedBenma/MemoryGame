  ...
  return (
    <div>
      <div className="buttons">
        <button onClick={startGame.bind(this)}>{buttonStart}</button>
        <button>Score: {cardsNbr}</button>
      </div>
      ...
      <div className="box">
        {animals.forEach((card, index) => (
          <Game
            ...
            card={card}
            nbrCards={cardsNbr}
            setCardsNbr={setCardsNbr}
            cardsNbr={cardsNbr}
            imagesClicked={imagesClicked}
            imagesClickedSet={imagesClickedSet}
            verifyCards={verifyCards}
            animals={animals}
            setAnimals={setAnimals}
            changeSrcImg={changeSrcImg}
            resetGame={resetGame}
            resetImagesClicked={resetImagesClicked}
            timer={timer}
            setTimer={setTimer}
